...
@section('title', 'Adicionar perfil de acesso')
        ...
        <div class="row">
            <div class="col-12">
                <div class="border mb-1 border-dark p-4">
                    <form action="{{ route('system.admin.perfis.index.cadastrar') }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" required placeholder="Digite aqui..." class="form-control"
                                            id="name" name="name">
                                    </div>
                                </div>
