<div class="modal fade" id="excluirSetor{{ $setor->id }}" tabindex="-1" aria-labelledby="excluirSetorLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="text-gray-800" id="excluirSetorLabel">Ops!</h6>
            </div>
            ...
            <div class="modal-footer">
                <form action="{{ route('sistema.usuario.setores.excluir', ['id' => base64_encode($setor->id)]) }}" method="post">
                    @csrf
                    @method('DELETE')
