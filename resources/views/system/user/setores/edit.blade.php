...
@section('content-page')
    <div class="container">
        ...
        <form action="{{ route('sistema.usuario.setores.atualizar', ['id' => base64_encode($setor->id)]) }}" method="post">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-3">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" value="{{ $setor->nome }}" id="nome" name="nome" placeholder="Setor">
                    </div>
                </div>
            </div>
