...
@section('title', 'Editar Colaborador: ' . $colaborador->nome)
        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="border mb-1 border-dark p-4">
                    <form
                        action="{{ route('sistema.usuario.colaboradores.atualizar', ['id' => base64_encode($colaborador->id)]) }}"
                        method="post">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input required type="text" placeholder="Digite aqui..." class="form-control"
                                            id="nome" name="nome" value="{{ $colaborador->nome }}">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input required type="email" class="form-control" id="email" name="email"
                                            placeholder="Digite aqui..." value="{{ $colaborador->email }}">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input required type="text" placeholder="Digite aqui..."
                                                ...
                                                id="cpf" value="{{ $colaborador->formatarCpf() }}" name="cpf">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text" id="basic-addon3"><i
                                                    class="fas fa-id-card-alt"></i></span>
                                            <input required type="text" placeholder="Digite aqui..."
                                                oninput="formatarRgInput(this)" value="{{ $colaborador->formatarRg() }}"
                                                maxlength="10" class="form-control" id="rg" name="rg">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <select required class="mb-3" name="cargo_id" id="cargo_id">
                                            ...
                                            @foreach ($cargos as $cargo)
                                                <option @selected($cargo->id == $colaborador->cargo_id) value="{{ $cargo->id }}">
                                                    {{ $cargo->nome }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <select required class="mb-3" name="situacao" id="situacao"
                                            ...
                                            @foreach ($situacoes as $situacao)
                                                <option @selected($situacao['value'] == $colaborador->situacao) value="{{ $situacao['value'] }}">
                                                    {{ $situacao['option'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <select required class="mb-3" name="escolaridade" id="escolaridade">
                                            ...
                                            @foreach ($escolaridades as $escolaridade)
                                                <option @selected($escolaridade['value'] == $colaborador->escolaridade) value="{{ $escolaridade['value'] }}">
                                                    {{ $escolaridade['option'] }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row mt-3">
                                    <div class="col-4">
                                        ...
                                        <input required class="mb-3" value="{{ $colaborador->data_nascimento }}"
                                            name="data_nascimento" type="date" id="data_nascimento">
                                    </div>

                                    <div class="col-4">
                                        <label for="data_inicio" class="form-label">Data de início na empresa</label><br>
                                        <input required class="mb-3" value="{{ $colaborador->data_inicio }}"
                                            name="data_inicio" type="date" id="data_inicio">
                                    </div>

                                    <div class="col-4">
                                        <label for="data_fim" class="form-label">Data final na empresa</label><br>
                                        <input required class="mb-3" value="{{ $colaborador->data_fim }}"
                                            @disabled($colaborador->situacao == 1) name="data_fim" type="date" id="data_fim">
                                    </div>
                                ...
                                <div class="row mt-2">
                                    <div class="col-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input required type="text" value="{{ $colaborador->formatarTelefone() }}"
                                                placeholder="Digite aqui..." oninput="formatarTelefoneComDDD(this)"
                                                maxlength="15" class="form-control" id="telefone" name="telefone">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input required type="text" placeholder="Digite aqui..."
                                                value="{{ $colaborador->qtd_dependentes }}"
                                    ...
                                    <div class="mb-3 col-12">
                                        ...
                                        <div class="input-group">
                                            <input required type="text" onkeyup="ViaCep(this)"
                                                value="{{ $colaborador->cep }}" onkeypress="return apenasNumeros();"
                                                maxlength="8" placeholder="Digite aqui..." class="form-control"
                                                id="cep" name="cep">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="mb-3 col-2">
                                        ...
                                        <div class="input-group">
                                            <input required type="text" placeholder="Digite aqui..."
                                                value="{{ $colaborador->cidade }}" class="form-control text-uppercase"
                                    ...
                                    <div class="mb-3 col-3">
                                        ...
                                        <div class="input-group">
                                            <input required type="text" placeholder="Digite aqui..."
                                                value="{{ $colaborador->bairro }}" class="form-control text-uppercase"
                                    ...
                                    <div class="mb-3 col-2">
                                        ...
                                        <div class="input-group">
                                            <input required type="text" onkeypress="return apenasNumeros();"
                                                maxlength="20" value="{{ $colaborador->numero }}"
                                                placeholder="Digite aqui..." class="form-control text-uppercase"
